  ...
  return (
    <AppScaffold title={song.displayName ?? song.name} back>
      <View style={styles.container}>
        {/* Left: song card with a link to the player page */}
        ...
        {/* Right: stacked skill panels — Reading/Writing/Flashcards are linked; Speaking isn't yet */}
...
const makeStyles = (theme: AppTheme) =>
  StyleSheet.create({
    ...
    skillColumn: { flex: 1, gap: 10 },
    skillRect: { flex: 1, borderRadius: 18, overflow: "hidden" },
    skillRectInner: {
      flex: 1,
      flexDirection: "row",
      alignItems: "center",
